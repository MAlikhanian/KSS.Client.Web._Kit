  ...
  const headerPin = () => {
    return (
      <Button
        ...
        aria-label={t('common.dataGrid.unpinColumn', { title })}
        title={t('common.dataGrid.unpinColumn', { title })}
      >
            ...
            {column.getCanSort() && (
              <>
                ...
                >
                  ...
                  <span className="grow">{t('common.dataGrid.sortAsc')}</span>
                ...
                >
                  ...
                  <span className="grow">{t('common.dataGrid.sortDesc')}</span>
            ...
            {props.tableLayout?.columnsPinnable && column.getCanPin() && (
              <>
                <DropdownMenuItem onClick={() => column.pin(column.getIsPinned() === 'left' ? false : 'left')}>
                  ...
                  <span className="grow">{t('common.dataGrid.pinLeft')}</span>
                ...
                <DropdownMenuItem onClick={() => column.pin(column.getIsPinned() === 'right' ? false : 'right')}>
                  ...
                  <span className="grow">{t('common.dataGrid.pinRight')}</span>
            ...
            {props.tableLayout?.columnsMovable && (
              <>
                ...
                >
                  ...
                  <span>{t('common.dataGrid.moveLeft')}</span>
                </DropdownMenuItem>
                <DropdownMenuItem
                ...
                >
                  ...
                  <span>{t('common.dataGrid.moveRight')}</span>
                </DropdownMenuItem>
              </>
            )}
            ...
            {props.tableLayout?.columnsVisibility && visibility && (
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>
                  ...
                  <span>{t('common.dataGrid.columns')}</span>
                </DropdownMenuSubTrigger>
                <DropdownMenuPortal>
                  <DropdownMenuSubContent>
                    {table
