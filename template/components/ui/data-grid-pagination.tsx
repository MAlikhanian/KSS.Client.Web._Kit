...
function DataGridPagination(props: DataGridPaginationProps) {
  ...
  const defaultProps: Partial<DataGridPaginationProps> = {
    ...
    sizesLabel: t('common.pagination.rowsPerPage'),
    sizesDescription: '',
    sizesSkeleton: <Skeleton className="h-8 w-44" />,
    moreLimit: 5,
    more: false,
    info: t('common.pagination.info'),
    ...
    >
      <div className="flex flex-wrap items-center space-x-2.5 pb-2.5 sm:pb-0 order-2 sm:order-1">
        {isLoading ? (
          ...
          <>
            <div className="text-sm text-muted-foreground">{t('common.pagination.rowsPerPage')}</div>
            <Select
              value={`${pageSize}`}
          ...
          <>
            ...
            {pageCount > 1 && (
              <div className="flex items-center space-x-1 order-1 sm:order-2">
                ...
                >
                  <span className="sr-only">{t('common.pagination.goToPreviousPage')}</span>
                ...
                >
                  <span className="sr-only">{t('common.pagination.goToNextPage')}</span>
